...
public class CodeGenerate {
    ...
    public void generateCod() throws Exception {
        String packageName = "com.example.es";
        String moduleName = "book";
        generateByTables(packageName, moduleName, "read_book_pd");
    }
    ...
    private DataSourceConfig getDataSourceConfig() {
        String dbUrl = "jdbc:mysql://localhost:3306/es_data?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC";
